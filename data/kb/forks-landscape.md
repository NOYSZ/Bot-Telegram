...
### DXVK Sarek (async/dynasync lineage)

- **Posisi:** community fork khusus Mali Vulkan 1.0/1.1 (yang ga support graphics pipeline library). Versi yang sering kepake: 1.7.2, 1.10.3, 1.11.1, 1.12.
- **Async vs dynasync:** "async" lama bikin shader compile background tapi sering crash; "dynasync" / "gplasync" generasi baru lebih stabil.
- **Saranin kalau:** user Mali black-screen / stutter shader compile di DXVK stable.
...
| Mali + game DX11 black screen | DXVK Sarek (1.11.1 atau 1.12) — bukan DXVK 2.x |
